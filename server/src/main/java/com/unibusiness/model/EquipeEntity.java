...
public class EquipeEntity {
    ...
    @ManyToMany(mappedBy = "equipes", fetch = FetchType.LAZY) private Set<UsuarioEntity> usuarios = new HashSet<>();
    @ManyToMany(mappedBy = "equipesAtribuidas", fetch = FetchType.LAZY) private Set<TarefaEntity> tarefas = new HashSet<>();
    public EquipeEntity() {}
    public EquipeEntity(String nome) { this.nome = nome; }
