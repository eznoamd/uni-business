...
public class Request {
    ...
    public Object get(String key) { return payload != null ? payload.get(key) : null; }
    public String getString(String key) { Object v = get(key); return v != null ? v.toString() : null; }
