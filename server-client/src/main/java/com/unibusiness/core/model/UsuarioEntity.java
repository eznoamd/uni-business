...
public class UsuarioEntity {
     ...
     *
     * Como nao existe mais servidor TCP mantendo conexoes abertas, a presenca
     * agora e simplesmente um campo no banco: setado para true no login e
     * false no logout/fechamento do app. As telas que mostram "online" fazem
     * polling periodico (ver ChatController) lendo esse campo.
     */
    @Column(nullable = false)
